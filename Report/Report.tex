    ...
    \section{PDE definition and methods}\label{secModelDef}
        ...
        \subsection{Physics-Informed Neural Networks (PINN)}\label{secPINN}
            ...
            \begin{equation}
                \label{eq:NN}
                \begin{aligned}
                    \mathcal{F}_{NN} \colon \quad & \Omega \times \mathcal{P} \to \mBB{V}^\boldmu, \\
                    & (x,\boldmu) \mapsto \hat{u}(x,\boldmu) \approx u(x,\boldmu).
                \end{aligned}
            \end{equation}
            %
            where $u(x,\boldmu)$ is the exact solution of the PDE and $\mBB{V}^\boldmu$ is the functional space where the solution lies. 
